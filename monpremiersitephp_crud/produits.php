...
<html lang="en">
  <head>
    ...
    <!-- Nouveau! Ajout des icônes Material Design -->
      ...
      <?php
          ...
          while ($row = $res->fetch_assoc()) {
              ...
              echo '<td class="text-center">';
                ...
                // bouton afficher
                echo '<a href="fiche_produit.php" class="btn btn-default" aria-label="Afficher le produit">';
                ...
                // bouton modifier
                echo '<a href="miseajour_produit.php" class="btn btn-default" aria-label="Modifier le produit">';
                ...
                // bouton supprimer
                echo '<a href="suppression_produit.php" class="btn btn-default" aria-label="Supprimer le produit">';
